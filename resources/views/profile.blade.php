        ...
        <div class="col-md-8 offset-md-2">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    @if($user->banner)
                        <div class="mb-3">
                            <!-- Ajustando o Banner para se ajustar ao container -->
                            <img src="{{ asset('storage/' . $user->banner) }}" alt="Banner" class="img-fluid rounded mb-3" style="width: 100%; height: auto; object-fit: cover;">
                        </div>
                    @else
                        <div class="mb-3">
                            <img src="https://via.placeholder.com/1200x200?text=Sem+Banner" alt="Banner Padrão" class="img-fluid rounded mb-3" style="width: 100%; height: auto; object-fit: cover;">
                        </div>
                    @endif
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        @else
                            <!-- Avatar Padrão, caso o usuário não tenha um avatar -->
